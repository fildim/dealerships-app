...
namespace DEALERSHIPS_APP.Migrations
{
    ...
    [Migration("20231125120048_SetMaxLengthAtUserType")]
    partial class SetMaxLengthAtUserType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DEALERSHIPS_APP.Models.Appointment", b =>
                {
                    ...
                    b.HasIndex(new[] { "GarageId" }, "IX_APPOINTMENTS_GARAGE_ID");

                    b.HasIndex(new[] { "OwnerId" }, "IX_APPOINTMENTS_OWNER_ID");

                    b.HasIndex(new[] { "VehicleId" }, "IX_APPOINTMENTS_VEHICLE_ID");
            ...
            modelBuilder.Entity("DEALERSHIPS_APP.Models.Ownership", b =>
                {
                    ...
                    b.HasIndex(new[] { "OwnerId" }, "IX_OWNERSHIPS_OWNER_ID");

                    b.HasIndex(new[] { "VehicleId" }, "IX_OWNERSHIPS_VEHICLE_ID");
